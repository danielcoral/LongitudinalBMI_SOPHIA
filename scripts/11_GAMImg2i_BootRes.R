...
bind_rows(
  ...
  geom_hline(yintercept = 0, linetype = "11", linewidth = .2) +
  geom_hline(
    aes(yintercept = -thresh),
    linetype = "11", linewidth = .2,
    na.rm = TRUE
  ) +
  geom_hline(
    aes(yintercept = thresh),
